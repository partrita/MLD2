...
![GitHub release (latest by date)](https://img.shields.io/github/v/release/partrita/MLD2?style=flat-square)
![License](https://img.shields.io/github/license/partrita/MLD2?style=flat-square)
![Build Status](https://img.shields.io/github/actions/workflow/status/partrita/MLD2/release-font.yml?style=flat-square)
...
[Releases](https://github.com/partrita/MLD2/releases) 페이지에서 최신 글꼴을 다운로드하세요.
...
# 터미널이 MLD2NerdFont-Regular를 사용하도록 설정
```
...
@font-face {
    font-family: 'MLD2';
    src: url('path/to/MLD2-Regular.woff2') format('woff2');
    font-display: swap;
}

code, pre {
    font-family: 'MLD2', 'Fira Code', monospace;
}
```
